...
module.exports.run = async function({ api, event, args }) {
  ...
  try {
    ...
    if (!data || !data.response) {
      return api.sendMessage("No response from Cassy Ai V3. Please try again.", event.threadID, event.messageID);
    }
    ...
    return api.sendMessage("⚠ Cassy Ai error occurred while processing your request. Please try again.", event.threadID, event.messageID);
  }
};
